...
//     }
  ...
  return (
    <>
      ...
      {loading?<><div className='container mt-4 main' id='front' style={{ height: "auto", maxHeight: "71vh", overflow: "auto", }}>
        <div className='mt-4'>
          <div className='mt-4 albums' style={{ display: "flex", gap: "10px", justifyContent: "space-evenly", flexWrap: "wrap" }}>
          <div className="card h-100" style={{ padding: "10px" }} >
              <Skeleton className="card-img-top" height="120px" width="100%" style={{ margin: "auto" }} baseColor='#161616' highlightColor='#1a1a1a' enableAnimation:true />
              <div style={{ marginTop: "10px" }}>
                <Skeleton baseColor='#161616' highlightColor='#1a1a1a' enableAnimation:true />
                <Skeleton baseColor='#161616' highlightColor='#1a1a1a' enableAnimation:true />
                <Skeleton width="70%" baseColor='#161616' highlightColor='#1a1a1a' enableAnimation:true />
      ...
      <div className='container mt-4 main' id='front' style={{ height: "auto", maxHeight: "71vh", overflow: "auto", }}>
        <div className='mt-4'>
          <div className='container' >
            <h3 style={{ color: "white", height: "0px", padding: "11px" }}>Albums</h3>
          </div>
          <div className='mt-4 albums' style={{ display: "flex", gap: "10px", justifyContent: "space-evenly", flexWrap: "wrap" }}>
            
            {song.map((data) => {
              return <div className="card h-100" onClick={() => { playsong(data.id) }} id={data.id} >
        ...
        <div className='mt-4'>
          <h3 className='container' style={{ color: "white", height: "0px", padding: "11px" }}>Playlists</h3>
          <div className='mainPlaylist mt-4' style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <div className='button' id='bt2' style={{ zIndex: "2" }}><button onClick={scrollUp}>
              <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 320 512"><path d="M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" /></svg></button >
            </div>
            ...
            <div className='button' id='bt1' style={{ zIndex: "2" }} ><button onClick={scrollDown}>
